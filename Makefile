.PHONY: help clean clean-build clean-pyc test build install release codecov doc
.DEFAULT_GOAL := help
...
clean-build: ## remove build artifacts
	...
	docker rmi -f hypnosapos/jupyxplorer:latest
...
build: ## build the docker image
	@docker build -t $(DOCKER_ORG)/jupyxplorer:latest .
